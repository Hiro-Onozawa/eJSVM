...
plot Plots every ::0+xmax*0::xmax*1-1 using ($1-xmax*0):2 with linespoints pt 1 ps 0.75 title linelabels[1],\
     ...
     Plots every ::0+xmax*2::xmax*3-1 using ($1-xmax*2):2 with linespoints pt 3 ps 0.75 title linelabels[3],\
     Plots every ::0+xmax*3::xmax*4-1 using ($1-xmax*3):2 with linespoints pt 4 ps 0.75 title linelabels[4]
